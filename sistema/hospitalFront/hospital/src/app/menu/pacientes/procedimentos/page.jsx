          ...
          <div className="mt-6 space-y-4">
            {procedimentos.map((procedimento) => (
              ...
              >
                ...
                <p className="text-sm text-slate-600">Data: {procedimento.data}</p>
                <p className="text-sm text-slate-600">Local: {procedimento.local}</p>
                <p className="text-sm text-slate-600">
                  Profissional: {procedimento.profissional}
                </p>
                <p className="mt-2 font-medium text-slate-800">Status: {procedimento.status}</p>
              </article>
            ))}
          </div>
        </section>
