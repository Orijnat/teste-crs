              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="mt-2 space-y-1 text-sm text-slate-600">
                    <p>
                      <strong>Kits:</strong> {procedimento.kits}
                    </p>
                    <p>
                      <strong>Paciente:</strong> {procedimento.paciente}
                    </p>
                    <p>
                      <strong>Médico:</strong> {procedimento.medico}
                    </p>
                    <p>
                      <strong>Sala:</strong> {procedimento.sala}
                    </p>
                  </div>
                </div>
