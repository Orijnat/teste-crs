...
export default function LaudosPage() {
  ...
  const [laudosRealizados, setLaudosRealizados] = useState([]);
  ...
  const criarLaudo = async (event) => {
    ...
    try {
      ...
      setLaudosRealizados((currentLaudos) => [
